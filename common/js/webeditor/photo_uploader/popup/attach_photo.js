...
function callFileUploader (){
	oFileUploader = new jindo.FileUploader(jindo.$("uploadInputBox"),{
		sUrl  : location.href.replace(/\/[^\/]*$/, '').replace(/\/js\/com\/idq\/webeditor\/photo_uploader\/popup/, '') + '/file_uploader.jsp',	//샘플 URL입니다.
		//sUrl  : location.href.replace(/\/[^\/]*$/, '') + '/file_uploader_html5.jsp',
